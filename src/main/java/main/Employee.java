...
public class Employee {
   ...
   *
   * @param lastName Last name of the employee, which may or may not contain information about
   *     whether the employee holds a CDL or is a line instructor
   ...
   *
   * @param lastName Last name of the employee, which may or may not contain information about
   *     whether the employee holds a CDL
   * @return false if the last name contains a variation of "(nocdl)" with any amount of whitespace
   *     between characters and any combination of lowercase and uppercase characters. Otherwise,
   *     returns true.
   */
   ...
   * @param lastName Last name of the employee, which may or may not contain information about
   *     whether the employee is a line instructor
   * @return true if the last name contains a variation of "(lineinstructor)" with any amount of
   *     whitespace between characters and any combination of lowercase and uppcase characters.
  ...
  public String toString() {
    return name.equals(new Name("", ""))
        ...
        : this.name.toString()
            + "\n"
            + (this.hasCDL ? "  CDL Holder" : "  Non-CDL Holder")
            + (this.lineInstructor ? "\n  Line Instructor" : "");
  }
}
